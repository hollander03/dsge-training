...
T40 = params(39)^2;
T42 = T40*params(12);
T62 = (1-params(13))/(params(44)+1-params(13));
T68 = params(15)/params(39);
T82 = (1-T68)/((1+T68)*params(14));
T188 = 1/(1+params(41)*params(39)*params(21));
T202 = (1-params(22))*(1-params(41)*params(39)*params(22))/params(22)/(1+(params(18)-1)*params(3));
T210 = params(41)*params(39)/(1+params(41)*params(39));
T237 = (1-params(20))*(1-params(41)*params(39)*params(20))/((1+params(41)*params(39))*params(20))*1/(1+(params(24)-1)*params(1));
lhs =y(32);
...
residual(5)= lhs-rhs;
lhs =y(13);
rhs =(-y(19))-y(33)+y(11)*params(44)/(params(44)+1-params(13))+y(13)*T62;
residual(6)= lhs-rhs;
lhs =y(14);
rhs =y(14)*T68/(1+T68)+y(14)*1/(1+T68)-T82*(y(19)+y(33));
residual(7)= lhs-rhs;
lhs =y(16);
...
residual(9)= lhs-rhs;
lhs =y(18);
rhs =y(17)*params(23)+y(14)*1/(1-T68)-y(14)*T68/(1-T68);
residual(10)= lhs-rhs;
lhs =y(39);
...
residual(16)= lhs-rhs;
lhs =y(24);
rhs =(-y(31))+y(29)-y(33)+params(44)/(params(44)+1-params(13))*y(22)+T62*y(24);
residual(17)= lhs-rhs;
lhs =y(25);
rhs =T68/(1+T68)*y(25)+1/(1+T68)*y(25)-T82*(y(33)+y(31)-y(29));
residual(18)= lhs-rhs;
lhs =y(27);
...
residual(20)= lhs-rhs;
lhs =y(29);
rhs =T188*(params(41)*params(39)*y(29)+y(29)*params(21)+y(20)*T202)+y(37);
residual(21)= lhs-rhs;
lhs =y(30);
rhs =T37*y(30)+y(30)*T210+y(29)*params(19)/(1+params(41)*params(39))-y(29)*(1+params(41)*params(39)*params(19))/(1+params(41)*params(39))+y(29)*T210+T237*(params(23)*y(28)+1/(1-T68)*y(25)-T68/(1-T68)*y(25)-y(30))+y(38);
residual(22)= lhs-rhs;
lhs =y(31);
...
T379 = 1-(T68/(1+T68)+1/(1+T68));
T381 = 1/(1-T68)-T68/(1-T68);
  g1(1,11)=(-params(9));
  g1(1,18)=(-(1-params(9)));
  g1(1,32)=1;
  g1(2,10)=1;
  ...
  g1(20,32)=(-params(18));
  g1(21,20)=(-(T188*T202));
  g1(21,29)=1-T188*(params(41)*params(39)+params(21));
  g1(21,37)=(-1);
  g1(22,25)=(-(T237*T381));
  g1(22,28)=(-(params(23)*T237));
  g1(22,29)=(-(T210+params(19)/(1+params(41)*params(39))-(1+params(41)*params(39)*params(19))/(1+params(41)*params(39))));
  g1(22,30)=1-(T37+T210-T237);
  g1(22,38)=(-1);
