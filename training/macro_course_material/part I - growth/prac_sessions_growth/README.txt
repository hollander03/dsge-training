...
Studies the transition behaviour of a simple Solow-Swan economy with Cobb-Douglas 
production function to its steady state when started with a capital stock different
from steady state.

### Solow_growth_rate_changes.mod 
Studies the transition behaviour of a simple Solow-Swan economy with Cobb-Douglas production 
...
Studies the transition behaviour of a simple Ramsey/Cass/Koopmans economy with Cobb-Douglas production 
