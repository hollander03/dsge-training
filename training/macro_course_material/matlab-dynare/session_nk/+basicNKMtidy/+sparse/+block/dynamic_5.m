...
residual=NaN(4, 1);
  y(18)=y(19);
  y(24)=y(18)*(params(3)+params(5))-(1+params(5))*y(26);
  y(33)=y(18)-y(30);
  residual(1)=(y(22))-(y(21)+y(40));
  residual(2)=(y(22))-(params(11)*y(5)+(1-params(11))*(y(23)*params(7)+params(8)*y(33))+y(28));
  residual(3)=(y(19))-(y(36)-1/params(3)*y(21));
  residual(4)=(y(23))-(y(27)+params(1)*y(40)+(1-params(6))*(1-params(6)*params(1))/params(6)*y(24));
if nargout > 3
    g1_v = NaN(13, 1);
g1_v(1)=(-params(11));
g1_v(2)=(-1);
