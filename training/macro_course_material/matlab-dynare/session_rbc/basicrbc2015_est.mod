...
estimation(datafile=data9519, mh_replic=0, // mh_nblocks=3, mh_drop=0.5, mh_jscale=0.99,
           mode_compute=0, mode_file=basicrbc2015_est_mode, load_mh_file, // mode_check,  
