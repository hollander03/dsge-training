...
options_ = [];
M_.fname = 'Solow_growth_rate_changes';
...
diary off;
diary('Solow_growth_rate_changes.log');
M_.exo_names = 'n';
M_.exo_names_tex = '{n}';
M_.exo_names_long = 'population growth rate';
M_.exo_names = char(M_.exo_names, 'g');
M_.exo_names_tex = char(M_.exo_names_tex, '{g}');
M_.exo_names_long = char(M_.exo_names_long, 'technology growth rate');
M_.endo_names = 'c';
M_.endo_names_tex = '{c}';
...
M_.param_names = char(M_.param_names, 'n_initial');
M_.param_names_tex = char(M_.param_names_tex, '{n_0}');
M_.param_names_long = char(M_.param_names_long, 'initial population growth rate');
M_.param_names = char(M_.param_names, 'g_initial');
M_.param_names_tex = char(M_.param_names_tex, '{g_0}');
M_.param_names_long = char(M_.param_names_long, 'initial technology growth rate');
...
erase_compiled_function('Solow_growth_rate_changes_static');
erase_compiled_function('Solow_growth_rate_changes_dynamic');
M_.orig_eq_nbr = 11;
M_.eq_nbr = 11;
M_.ramsey_eq_nbr = 0;
...
delta = M_.params( 3 );
M_.params( 4 ) = 0.01;
n_initial = M_.params( 4 );
M_.params( 5 ) = 0.02;
g_initial = M_.params( 5 );
%
% INITVAL instructions
%
options_.initval_file = 0;
oo_.exo_steady_state( 2 ) = M_.params(5);
oo_.exo_steady_state( 1 ) = M_.params(4);
oo_.steady_state( 2 ) = ((M_.params(5)+M_.params(3)+oo_.exo_steady_state(1)+M_.params(5)*oo_.exo_steady_state(1))/M_.params(1))^(1/(M_.params(2)-1));
...
oo_.steady_state( 10 ) = oo_.steady_state(11)+oo_.exo_steady_state(2);
oo_.steady_state( 9 ) = oo_.exo_steady_state(1)+oo_.steady_state(11)+oo_.exo_steady_state(2);
if M_.exo_nbr > 0
...
oo_.exo_steady_state( 1 ) = M_.params(4);
oo_.steady_state( 2 ) = ((M_.params(3)+oo_.exo_steady_state(1)+oo_.exo_steady_state(2)+oo_.exo_steady_state(1)*oo_.exo_steady_state(2))/M_.params(1))^(1/(M_.params(2)-1));
oo_.steady_state( 3 ) = oo_.steady_state(2)^M_.params(2);
oo_.steady_state( 1 ) = (1-M_.params(1))*oo_.steady_state(3);
oo_.steady_state( 4 ) = oo_.steady_state(3)-oo_.steady_state(1);
oo_.steady_state( 7 ) = log(oo_.steady_state(3));
...
var_list_ = char('k','y','c','invest');
rplot(var_list_);
var_list_ = char('log_k','log_y','log_c','log_invest');
rplot(var_list_);
...
save('Solow_growth_rate_changes_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Solow_growth_rate_changes_results.mat', 'oo_recursive_', '-append');
end
