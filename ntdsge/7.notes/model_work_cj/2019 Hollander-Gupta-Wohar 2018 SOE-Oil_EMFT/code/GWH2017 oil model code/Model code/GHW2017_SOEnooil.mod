...
w = w(-1) + pi_wage - pi_tot;                      //add back real wage definition
...
estimation(datafile=GHWEstimation6, mh_nblocks=3, mh_replic=100000, mh_drop=0.5, mh_jscale=0.30, 
           mode_compute=0, mode_file=GHW2017_SOEnooil_mode, mode_check, bayesian_irf, irf=20, moments_varendo, conditional_variance_decomposition=[1:20],
