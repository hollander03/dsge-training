...
omega	=	0.1219	;
 ...
 thetatrY	=	0.00	; // thetatrY	=	0.1949
 thetaGY	=	0.00	; // thetaGY	=	0.1526
 thetaiGY	=	0.00	; // thetaiGY	=	0.1737
 thetatauCY	=	0.1757	; 
 thetatauNY	=	0.162	;
 thetatauKY	=	0.5098	;
 thetaGB	=	0.1731	;
 thetaiGB	=	0.00	; // thetaiGB	=	0.4532
 thetatrB	=	0.00	; // thetatrB	=	0.3832
 thetatauNB	=	0.00	; // thetatauNB	=	0.5774
 thetatauKB	=	0.00	; // thetatauKB	=	0.1917
 thetatauCB	=	0.00	; // thetatauCB	=	0.1168
