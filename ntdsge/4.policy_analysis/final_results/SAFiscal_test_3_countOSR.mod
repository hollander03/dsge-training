...
osr_params thetaiGY thetaiGB ; //   phiR phiPi phiDY  rhog rhoiG  rhog rhoiG    thetaGY thetaGB 
osr(order=1, irf=20, graph_format=fig, nodisplay) b y r g iG tr gdebtgdp_ db_ dy_ R_ dg_ diG_ dtr_ rrp rrpstar susgap susgapgdp pbudsus pbud dy piY; // c cI cJ i x im piY piC piIM N piW s;
%--------------------------------------------------------------------------
