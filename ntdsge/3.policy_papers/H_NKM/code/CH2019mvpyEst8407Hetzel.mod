...
// option 8 from 5907 run with M4divisia (%-change q-on-q) MAIN (this option)

var m v p y r int int_T pii ytilde yn rn rmc h fr xi_z  xi_ms n ytilde_obs pii_obs int_obs m_obs xi_md; // xi_v xi_p
...
parameters alppha betta eta_c eta_m eta_n theta_p
           ...
           kapa_pi kapa_y
           ytilde_ss pii_ss int_ss m_ss; // rho_v rho_p
...
nu_fr = 1;      // elasticity of free reserves to nominal interest rate        500
...
%%% 1959--2007
//ytilde_ss = -0.005308; 
//pii_ss = 0.0356682;       //  (y-on-y)
//int_ss = 0.0548651;       //  (ann)
// m_ss = 0.010973194;         //  (M4 Div pc q-on-q)
//m_ss = 0.044167;         //  (M4 Div pc y-on-y)
//rr_ss = -0.0129053;

%%% 1984--2007
ytilde_ss = -0.00759341; 
pii_ss = 0.024899295;
int_ss = 0.049106316;
m_ss = 0.011266;      // (M4 Div pc q-on-q)
//rr_ss = -0.01728564;
...
//load_mh_file, mode_file=CH2017mvpyEst8407Hetzel2_mode,  CH2016Estimation5907 (NB change ss values),  CH2016Estimation8407
//conditional_variance_decomposition=[1:20], forecast=8,
//, nodisplay

estimation(datafile=CH2019Estimation8407m4, mh_nblocks=3, mh_replic=150000, mh_drop=0.5, mh_jscale=0.42, 
           mode_compute=0, mode_file=CH2019mvpyEst8407Hetzel_mode, mode_check, load_mh_file, bayesian_irf, irf=20, moments_varendo, conditional_variance_decomposition=[1:20],
           graph_format=fig) m v p y int pii r ytilde h fr n;

// Shock Decomposition option

shock_decomposition m v p y int_obs pii_obs r ytilde_obs m_obs;  // rr_obs
