...
m_ss = 0.00992075;   // Div M4 qq // Div M4 yy 0.03972039795663 (1960-2019)
////rr_ss = -0.0129053;
...
estimation(datafile=CH2020Estimation5919m4, mh_nblocks=3, mh_replic=100000, mh_drop=0.5, mh_jscale=0.275, 
           mode_compute=0, mode_file=CH2018mvpyEst5907Hetzel_mode, mode_check, bayesian_irf, irf=20, moments_varendo, conditional_variance_decomposition=[1:20],
           graph_format=fig, nodisplay) m v p y int pii r ytilde h fr n;
