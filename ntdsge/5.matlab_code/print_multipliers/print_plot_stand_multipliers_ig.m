...
gbarbase=M_.params(loc(M_.param_names(:,:),'iGbar'));

resp_mat_fis(1,:)=oo_.irfs.iG_etaiG(:,1:100);
resp_mat_y(1,:)=oo_.irfs.y_etaiG(:,1:100);
resp_mat_c(1,:)=oo_.irfs.c_etaiG(:,1:100);
resp_mat_i(1,:)=oo_.irfs.i_etaiG(:,1:100);
