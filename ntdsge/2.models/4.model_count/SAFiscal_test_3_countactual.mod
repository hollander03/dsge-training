...
%% CHECK: foreign/external rate missing? NOTE: RECENTLY UPDATED TO INCLUDE rrpstar in NFA equation in "...test_5.mod"
...
%%%%% estimated params fixed
 ...
 gammaB	=	0.038477396 ;
 phiR	=	0.871525583	;
 phiPi	=	1.567210076	;     // OSR params 3.24392 opt / 2.13134 opt coord b,y // OSR params 3.12572 opt / 3.35216 opt coord b,pb^sus //
 phiDY	=	0.387040673	;     // OSR params 1.32413 opt / 8.35792 opt coord b,y // OSR params 1.10191 opt / 1.20576 opt coord b,pb^sus //

 thetatrY	=	0.18859552	;		
 thetaGY	=	0.109816633	; // OSR params -0.656391 b,y // OSR params 0.0347252 b,pb^sus // Original: 0.109816633 // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 thetaiGY	=	0.195265714	; // OSR params 0.148869 b,y  // OSR params  0.194994 b,pb^sus // Original: 0.195265714 // x2 : 0.4 // x4 : 0.80 // 1.6 x8 
 thetatauCY	=	0.204056348	;
 thetatauNY	=	0.174579288	;
 thetatauKY	=	0.5297234	;
 thetaGB	=	0.180724061     ; // OSR params 1.38299 b,y  // OSR params 0.324587 b,pb^sus // Original: 0.180724061 // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
 thetaiGB	=	0.56776651   ; // OSR params 0.66164 b,y   // OSR params 0.582071 b,pb^sus // Original: 0.56776651 // x2 : 1.1355 // x4 : 2.2711 // 4.5421 x8 
...
%(26) Net foreign assets --> convert bstar to net foreign debt. CHECK: foreign/external rate missing?
...
estimation(datafile=data_18q4_V2_shocks3, mh_nblocks=2, mh_replic=100000, mh_drop=0.5, mh_jscale=0.1, 
           mode_compute=0, mode_file=SAFiscal_test_2_count_mode, // mode_check, SAFiscal_test_2_count_mode                     // mode_file=Copy_2_of_SAFiscal_mode, (latest), Copy_9_of_SAFiscal_mode
           moments_varendo, // conditional_variance_decomposition=[1:20], // bayesian_irf, irf=20, 
           graph_format=fig, nodisplay) gyratio iGyratio tryratio tauCyratio tauNyratio tauKyratio b y r g iG tr gdebtgdp_ db_ dy_ R_ dg_ diG_ dtr_ rrp rrpstar c cI cJ i x im piY piC piIM N piW s susgapgdp by pbud pbudsus susgap; //
...
%% dynare SAFiscal_test_3_countOSRest.mod
