...
%% OSRs for government investment counterfactual for loss function with y, b: individual ONLY
...
%%%%% estimated params fixed
 ...
 thetatrY	=	0.18859552	;		
 thetaGY	=	0.109816633	; // Original: 0.109816633 // OSR params -0.656391 b,y // OSR params 0.0347252  y,pb^sus   // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 thetaiGY	=	-0.660107	; // Original: 0.195265714 // OSR params 0.148869 b,y -0.660107 (only)  // OSR params 0.194994  y,pb^sus coord 0.189902  // x2 : 0.4 // x4 : 0.80 // 1.6 x8 
 thetatauCY	=	0.204056348	;
 thetatauNY	=	0.174579288	;
 thetatauKY	=	0.5297234	;
 thetaGB	=	0.180724061 ;    // Original:0.180724061 // OSR params 1.38299 b,y (joint)   // OSR params 0.324587  y,pb^sus  // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
 thetaiGB	=	2.29841      ; // Original: 0.56776651 // OSR params 0.66164 b,y (joint) 2.29841 (only)  // OSR params 0.582071  y,pb^sus coord 1.0261  // x2 : 1.1355 // x4 : 2.2711 // 4.5421 x8 
