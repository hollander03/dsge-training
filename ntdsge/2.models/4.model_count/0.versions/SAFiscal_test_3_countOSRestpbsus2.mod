...
%% OSRs for government consumption counterfactuals for loss function with pbsusgapgdp y: individual 
...
%%%%% estimated params fixed
 ...
 gammaB	=	0.038477396 ;
 phiR	=	0.871525583	;
 phiPi	=	1.567210076 ;   // original 1.567210076 // G.Consumption: 1.63138 opt coord pbsusgdp,y // G.Investment: // OSR params 3.24392 opt / 2.13134 opt coord b,y // OSR params 3.12572 opt / 3.35216 opt coord b,pb^sus //
 phiDY	=	0.387040673	;   // original 0.387040673 // G.Consumption: 0.416474 opt coord pbsusgdp,y // G.Investment: // OSR params 1.32413 opt / 8.35792 opt coord b,y // OSR params 1.10191 opt / 1.20576 opt coord b,pb^sus //

 thetatrY	=	0.18859552	;		
 thetaGY	=	0.033229	; // Original: 0.109816633// G.Consumption: OSR params 0.033229 pbsusgdp ,y  // 0.0210663 opt coord pbsusgdp, y // G.Invest: // OSR params -0.656391 b,y // OSR params 0.0347252  y,pb^sus   // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 ...
 thetaGB	=	0.327462 ; // Original: 0.180724061 // G.Consumption: OSR params 0.327462 pbsusgdp ,y // 0.350575 opt coord pbsusgdp, y// OSR params 1.38299 b,y  // OSR params 0.324587  y,pb^sus  // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
...
%% dynare SAFiscal_test_3_countOSRestpbsus3.mod
