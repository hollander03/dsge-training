...
%% OSRs for government consumption counterfactuals for loss function with y, b: MP policy coord 
...
%%%%% estimated params fixed
 ...
 gammaB	=	0.038477396 ;
 phiR	=	0.871525583	;
 phiPi	=	2.01611	;   // original 1.567210076 // G.Consumption: 2.01611 opt coord b,y // G.Investment: // OSR params 3.24392 opt / 2.13134 opt coord b,y // OSR params 3.12572 opt / 3.35216 opt coord b,pb^sus //
 phiDY	=	0.629279 ;   // original 0.387040673 // G.Consumption: 0.629279 opt coord b,y // G.Investment: // OSR params 1.32413 opt / 8.35792 opt coord b,y // OSR params 1.10191 opt / 1.20576 opt coord b,pb^sus //

 thetatrY	=	0.18859552	;		
 thetaGY	=	-0.912987	; // G.Consumption: OSR params -0.681838 // OSR params -0.912987 opt MP coord b,y // w/ G.Invest: // OSR params -0.656391 b,y // OSR params 0.0347252  y,pb^sus  // Original: 0.109816633 // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 thetaiGY	=	0.195265714	; // Original: 0.195265714 // G.Invest: // OSR params 0.148869 b,y  // OSR params 0.194994  y,pb^sus coord 0.189902 //  x2 : 0.4 // x4 : 0.80 // 1.6 x8 
 thetatauCY	=	0.204056348	;
 thetatauNY	=	0.174579288	;
 thetatauKY	=	0.5297234	;
 thetaGB	=	1.78561 ; // Original: 0.180724061 // G.Consumption: OSR params 1.4229  // OSR params 1.78561 opt MP coord b,y // OSR params 1.38299 b,y  // OSR params 0.324587  y,pb^sus  // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
 thetaiGB	=	0.56776651   ; // Original: 0.56776651 // OSR params 0.66164 b,y   // OSR params 0.582071  y,pb^sus coord 1.0261  // x2 : 1.1355 // x4 : 2.2711 // 4.5421 x8 
...
estimation(datafile=data_18q4_V2_shocks3, load_mh_file, // mh_replic=150000, mh_nblocks=2, mh_drop=0.5, mh_jscale=0.1, // 
...
%% dynare SAFiscal_test_3_countOSRestpbsus2.mod
