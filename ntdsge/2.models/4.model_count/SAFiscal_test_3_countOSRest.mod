...
%% OSRs for government investment counterfactual for loss function with y, pbsusgapgdp: coord with MP
...
%%%%% estimated params fixed
 ...
 gammaB	=	0.038477396 ;
 phiR	=	0.871525583	;
 phiPi	=	3.35216	;   // original 1.567210076  // OSR params 3.24392 opt / 2.13134 opt coord b,y // OSR params 3.12572 opt / 3.35216 opt coord b,pb^sus //
 phiDY	=	1.20576	;   // original 0.387040673  // OSR params 1.32413 opt / 8.35792 opt coord b,y // OSR params 1.10191 opt / 1.20576 opt coord b,pb^sus //

 thetatrY	=	0.18859552	;		
 thetaGY	=	0.109816633	; // OSR params -0.656391 b,y // OSR params 0.0347252  y,pb^sus  // Original: 0.109816633 // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 thetaiGY	=	0.189902	; // OSR params 0.148869 b,y  // OSR params 0.194994  y,pb^sus coord 0.189902 // Original: 0.195265714 // x2 : 0.4 // x4 : 0.80 // 1.6 x8 
 thetatauCY	=	0.204056348	;
 thetatauNY	=	0.174579288	;
 thetatauKY	=	0.5297234	;
 thetaGB	=	0.180724061    ; // OSR params 1.38299 b,y  // OSR params 0.324587  y,pb^sus // Original: 0.180724061 // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
 thetaiGB	=	1.0261   ; // OSR params 0.66164 b,y   // OSR params 0.582071  y,pb^sus coord 1.0261 // Original: 0.56776651 // x2 : 1.1355 // x4 : 2.2711 // 4.5421 x8 
