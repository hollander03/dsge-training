...
epsRPstarbar         =   1; % redundent: ((1-epsRPGbar+gammaBstar)/gammaBstar)^gammaBstar;
...
%Coef. UIP
lamRPstar            =   1; % redundent: (epsRPstarbar^(1/gammaBstar))/(1+gammaBstar-gammaBstar*epsRPstarbar^(1/gammaBstar));
...
if check==0,%Dynare Switch indicating good steady state
    ...
    pbud=0; pbudsus=0; susgap=0; susgapgdp=0; credratefull_=0; credratenan_=0; credratenanpos_=0; credratenanneg_=0; epsiloncred=0;
    
    gyratio=0; iGyratio=0; tryratio=0; tauCyratio=0; tauNyratio=0; tauKyratio=0; tauCrev=0; tauNrev=0; tauKrev=0;
    
    rpsa=0; tb=0; tby=0; pbudtest=0; govbudbal=0; govbudbalgdp=0; govdsc=0; govdscgdp=0; govdsctest=0; ndy=0; ndc=0; ndi = 0; ndg = 0; ndiG = 0; ndex = 0; ndim = 0; 
    
    trJwelf=0; trJgap=0; pbudy=0;
    ...
    db_=log(gzbar+0.00529246)*100;  %    db_= 1.194766034;   actaul is different CHECK all SSs
    gdebtgdpdt_ = 0;
    gdebtgdp_ = (41.131);
    by = 0;
    bstary = 0;
