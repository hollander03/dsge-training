...
function  f = SAFiscal_ss_equations(y, betta, sigmaL, kappa, gz, alpha, varphiH, varphiW,...
    ...
    corp_gov_spread,pibar,epsRPK2,given_alphaG,given_alphaK,alphaG_target,alphaK_target)
...
cJ    = exp(y( 13));
cI    = exp(y( 14));
trJ   = (y( 15)); %% converted to exp in _ss.m file... not here, bad steady state; negative trJ
...
%rental rate
rK    = 1/((1-tauK)*epsRPK)*(gz/betta-(1-delta)*epsRPK-tauK*delta*epsRPK)*pI;
