...
%%%%% estimated params fixed
 ...
 thetaiGB	=	0.5964	; // orig: 0.5964 // opt: // opt: 1.0295 w/ thetatauCB
 thetatrB	=	0	; // orig: 0.3788 // perm: 0
 thetatauNB	=	0.6474	; // orig: 0.6474  // opt: 2.44725
 thetatauKB	=	0.1814	; // orig: 0.1814 // opt: 19.097 NOTE - only one instrument; rho is negative. see excel file
 thetatauCB	=	0.1031	; //  orig: 0.1031 // opt: 5.35259
...
% var R_ ;
% periods 1, 2, 3, 4, 5, 6:20 ;
% values	1.622022011, 1.601754062, 1.405011477, 1.220092793, 0.990779147, 0 ;
...
conditional_forecast(parameter_set = calibration, conf_sig = 0.68, controlled_varexo = (etatr), replic = 10000); // posterior_mean %% etaiG, etaC, etaN, etag, etaI, etaepsilon, etagz), , etaR
...
% save BIG_3_simp_foreplots.mat forecasts %% targeted
 save BIG_3_simp_foreplots_perm.mat forecasts %% targeted
% save BIG_3_simp_foreplots_FPL_perm.mat forecasts %% targeted
% save BIG_3_simp_foreplots_UBPL_perm.mat forecasts %% targeted
% save BIG_3_simp_foreplots_SDR_perm.mat forecasts %% targeted
