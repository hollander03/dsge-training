...
gdebtgdp_/100     = b - y + (40.00)/100 + me_b;           //  use + (41.131)/100 for gdebtgdp_
...
estimation(datafile=data_19q4_V2, nobs=104, load_mh_file, mh_replic=100000, mh_nblocks=3, mh_drop=0.5, mh_jscale=0.225,  // load_mh_file, mh_replic=100000,     mh_replic=200000, mh_jscale=0.2,  
...
//// Shock Decomposition option
 ...
 plot_shock_decomposition(graph_format=(fig), use_shock_groups=transfers, colormap=jet, steadystate) cI cJ gdebtgdp_ rrp b y r g by susgapgdp dtr_ tr trJgap tauC tauN tauK;

 plot_shock_decomposition(graph_format=(fig), use_shock_groups=groups, colormap=jet, steadystate) cI cJ gdebtgdp_ rrp b y r g by susgapgdp dtr_ tr trJgap tauC tauN tauK;
