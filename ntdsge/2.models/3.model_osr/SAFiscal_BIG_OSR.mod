...
%% based on _test_3.mod. Model applied to BIG analysis.
...
%%%%% estimated params fixed
 ...
 thetatrY	=	0.18859552	; // transfer OSR output // Original: 0.18859552 //set_param_value('thetatrY',thetatrY)
 thetaGY	=	0.109816633	; // OSR params // Original: 0.109816633 // x2 : 0.22 // x4 : 0.44 // 0.80 x8 
 thetaiGY	=	0.195265714	; // OSR params // Original: 0.195265714 // x2 : 0.4 // x4 : 0.80 // 1.6 x8 
 thetatauCY	=	0.204056348	;
 thetatauNY	=	0.174579288	;
 thetatauKY	=	0.5297234	;
 thetaGB	=	0.180724061 ; // OSR params // Original: 0.180724061 // x2 : 0.3614 // x4 : 0.7229 // 1.4458 x8 
 thetaiGB	=	0.56776651  ; // OSR params // Original: 0.56776651 // x2 : 1.1355 // x4 : 2.2711 // 4.5421 x8 
 thetatrB	=	0.476795906	; // transfer OSR debt weights // Original: 0.476795906
 thetatauNB	=	0.254758939	;
 thetatauKB	=	0.174175636	;
 thetatauCB	=	0.195542651	;
 rhoepsG	=	0.75057545	;
 rhoepsiG	=	0.72063872	;
 rhoepstr	=	0.489992919	; // transfer shock persistence
 ...
 rhog	=	0.872847324	;
 rhoiG	=	0.745476518	;
 rhotr	=	0.499480176	;     // transfer OSR instrument persistence // Original: 0.499480176
...
%===================================================================================================
% OSR / Ramsey optimal fiscal adjustment
%===================================================================================================
%--------------------------------------------------------------------------
optim_weights;
...
// cJ 1; // non-ricardian consumption
// cI 1; // ricardian consumption
y 1;
b 1;
// susgapgdp 1; %% fiscal sustainability gap %% USE
// piC 1; %% for optimal coord with MP

%%%% Instruments %%%%
//g 0; %% iG most NB factor
// iG 0;
// r 0; %% for optimal coord with MP
//tr 0.5;   %% 

// // susgap 1; %% fiscal sustainability gap %% Needs to be scaled to gdp
// // c 1; %% robust to excluding c
// // by 1; %% robust to seperating b and y

end;

osr_params thetaiGY thetaiGB thetaGY thetaGB ; // thetaiGY thetaiGB    thetatrY // rhotr thetatrY thetatrB // phiR phiPi phiDY  rhog rhoiG  rhog rhoiG thetaGY thetaGB   thetaiGY thetaiGB  
osr(order=1, irf=40, graph_format=fig, nodisplay) c cI cJ b y r g iG tr gdebtgdp_ db_ dy_ R_ dg_ diG_ dtr_ rrp rrpstar susgap susgapgdp pbudsus pbud dy piY; // c cI cJ i x im piY piC piIM N piW s;
%--------------------------------------------------------------------------
